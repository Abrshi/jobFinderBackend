        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxJobSources = table.Column<int>(type: "integer", nullable: false),
                    CanGenerateCV = table.Column<bool>(type: "boolean", nullable: false),
                    CanGenerateCoverLetter = table.Column<bool>(type: "boolean", nullable: false),
                    CanUseInterviewAI = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    JobPlatformId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Jobs_JobPlatforms_JobPlatformId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GeneratedCoverLetters_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GeneratedCoverLetters_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GeneratedCVs_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobRecommendations_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserJobSources", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserJobSources_JobPlatforms_JobPlatformId",
                        column: x => x.JobPlatformId,
                        principalTable: "JobPlatforms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserJobSources_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "integer", nullable: false),
                    JobId = table.Column<int>(type: "integer", nullable: false),
                    GeneratedCVId = table.Column<int>(type: "integer", nullable: true),
                    GeneratedCoverLetterId = table.Column<int>(type: "integer", nullable: true),
                    Status = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Applications_GeneratedCVs_GeneratedCVId",
                        column: x => x.GeneratedCVId,
                        principalTable: "GeneratedCVs",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Applications_GeneratedCoverLetters_GeneratedCoverLetterId",
                        column: x => x.GeneratedCoverLetterId,
                        principalTable: "GeneratedCoverLetters",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applications_GeneratedCoverLetterId",
                table: "Applications",
                column: "GeneratedCoverLetterId");

            migrationBuilder.CreateIndex(
                name: "IX_Applications_GeneratedCVId",
                table: "Applications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GeneratedCoverLetters_JobId",
                table: "GeneratedCoverLetters",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_GeneratedCoverLetters_UserId",
                table: "GeneratedCoverLetters",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_GeneratedCVs_JobId",
                table: "GeneratedCVs",
                column: "JobId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobRecommendations_JobId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserJobSources_JobPlatformId",
                table: "UserJobSources",
                column: "JobPlatformId");

            migrationBuilder.CreateIndex(
                name: "IX_UserJobSources_UserId",
                table: "UserJobSources",
                column: "UserId");
